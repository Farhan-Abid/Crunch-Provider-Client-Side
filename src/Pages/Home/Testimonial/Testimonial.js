      ...
      >
        <div>
          ...
          <div className="myCarousel">
            ...
            <h4>Dealer</h4>
            <p>
              It's freeing to be able to catch up on the items first and not be
              distracted by other providers. I love them!
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="myCarousel">
            ...
            <h4>Customer for 7 years</h4>
            <p>
              The simple and intuitive product delivery makes it easy for me use. I highly
              recommend them to my peers.
            </p>
          </div>
        </div>
